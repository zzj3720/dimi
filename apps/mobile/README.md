...
1. Run a relay with a public `wss://` endpoint:
   ...
   ```sh
   HOST=0.0.0.0 PORT=8787 vp run @k-3720/relay#start
   ```
...
```sh
K3720_CHANNEL=internal K3720_VERSION_CODE=2 vp run @k-3720/mobile#build:android:internal
vp run @k-3720/distribution#publish:android -- \
