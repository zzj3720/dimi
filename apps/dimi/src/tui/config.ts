 ...
 * dimi client preferences such as terminal UI and update behavior.
 */
...
export const STATUS_LINE_ITEMS = ['mode', 'model', 'tasks', 'cwd', 'git', 'tips'] as const;
