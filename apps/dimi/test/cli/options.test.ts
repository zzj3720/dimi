 ...
 * Run: pnpm -C apps/dimi exec vitest run test/cli/options.test.ts
 */
...
describe("CLI options parsing", () => {
  ...
  describe("--version", () => {
    it("prints the version string and exits", () => {
      ...
      expect(() => program.parse(["node", "dimi", "--version"])).toThrow();
    ...
    it("supports -V as a short alias", () => {
      ...
      expect(() => program.parse(["node", "dimi", "-V"])).toThrow();
  ...
  describe("--model / -m", () => {
    it("parses -m as a model override", () => {
      expect(parse(["-m", "dimi/k2"]).model).toBe("dimi/k2");
    });

    it("parses --model=value as a model override", () => {
      expect(parse(["--model=dimi/k2.5"]).model).toBe("dimi/k2.5");
    });
  ...
  describe("sub-commands", () => {
    it("routes upgrade without calling the main action", () => {
      ...
      program.parse(["node", "dimi", "upgrade"]);
    ...
    it("routes update alias to the upgrade handler", () => {
      ...
      program.parse(["node", "dimi", "update"]);
