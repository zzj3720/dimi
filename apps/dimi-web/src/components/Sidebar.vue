<!-- apps/dimi-web/src/components/Sidebar.vue -->
...
// Logo easter-egg: clicking the Dimi mark plays one quick blink. It's a one-shot
...
// Logo long-press easter-egg: holding the Dimi mark for 1 second opens the
      ...
      <div class="ch">
        <div class="ch-brand">
          <template v-if="!isMacosDesktop">
            <svg ref="logoRef" class="ch-logo" :class="{ 'is-dev': isDev }" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Dimi" @click="onLogoClick" @pointerdown="onLogoPointerDown" @pointerup="onLogoPointerUp" @pointercancel="onLogoPointerUp">
              <defs>
                <mask id="dimiEyes" maskUnits="userSpaceOnUse">
              ...
              <rect x="1" y="1" width="30" height="20" rx="6" fill="var(--logo)" mask="url(#dimiEyes)" />
            </svg>
            <span class="ch-name">Dimi</span>
          </template>
        </div>
        <IconButton
          v-if="!isMacosDesktop"
