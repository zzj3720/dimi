<!-- apps/dimi-web/src/components/settings/SettingsDialog.vue -->
...
import type { Accent, ColorScheme } from "../../composables/useDimiWebClient";
        ...
        <section v-show="activeTab === 'account'" class="panel">
          <section class="sec">
            ...
            <div class="row">
              <span class="rlabel">{{
                authReady
                  ? (accountModel?.split("/")[0] ?? t("providers.status.connected"))
