// apps/dimi-web/src/api/daemon/client.ts
// DaemonDimiWebApi — implements DimiWebApi using the daemon REST + WS APIs.

import type { DimiApiConfig } from "../config";
...
export class DaemonDimiWebApi implements DimiWebApi {
  private readonly http: DaemonHttpClient;
  private readonly config: DimiApiConfig;

  constructor(config: DimiApiConfig) {
    this.config = config;
