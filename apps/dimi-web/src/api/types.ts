// apps/dimi-web/src/api/types.ts
// App-facing camelCase model + DimiWebApi interface.
 ...
 */
export const COMPACTION_MARKER_METADATA_KEY = "dimiWeb.compaction";
...
export interface DimiEventHandlers {
  onEvent(event: AppEvent, meta: DimiEventMeta): void;
...
export interface DimiEventMeta {
  sessionId: string;
  seq: number;
  stream?: {
    turnId: number;
...
export interface DimiEventConnection {
...
// ---------------------------------------------------------------------------
// DimiWebApi — the app-facing interface
// ---------------------------------------------------------------------------
...
export interface DimiWebApi {
  ...
  connectEvents(handlers: DimiEventHandlers): DimiEventConnection;
